...
class Qenta_CheckoutPage_Block_Additional_Installment extends Mage_Core_Block_Template
{

    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('qenta/checkoutpage/additional/installment.phtml');
    }
