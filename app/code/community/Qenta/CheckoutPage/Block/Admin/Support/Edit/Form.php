...
class Qenta_CheckoutPage_Block_Admin_Support_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('replyto', 'text', array(
            'label'    => Mage::helper('qenta_checkoutpage')->__('Your e-mail address'),
            'class'    => 'validate-email',
            'name'     => 'replyto'
        ));

        $fieldset->addField('description', 'textarea', array(
            'label'    => Mage::helper('qenta_checkoutpage')->__('Your message'),
            'class'    => 'required-entry',
            'required' => true,
            'name'     => 'description',
