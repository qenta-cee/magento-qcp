...
class Qenta_CheckoutPage_Model_Invoice extends Qenta_CheckoutPage_Model_Abstract
{
    /**
     ...
     * @var string [a-z0-9_]
     **/
    protected $_code = 'qenta_checkoutpage_invoice';
    ...
    public function assignData($data)
    {
        ...
        $key = 'qenta_checkoutpage_invoice_dob';
        if (is_array($data)) {
    ...
    public function getCustomerDob()
    {
        ...
        if ($additionalInfo->hasAdditionalInformation('qenta_checkoutpage_invoice_dob')) {
            $dob = $additionalInfo->getAdditionalInformation('qenta_checkoutpage_invoice_dob');
            if ($dob) {
