...
class Qenta_CheckoutPage_Model_Invoiceb2b extends Qenta_CheckoutPage_Model_Abstract
{
    /**
    ...
    * @var string [a-z0-9_]
    **/
    protected $_code = 'qenta_checkoutpage_invoiceb2b';
    ...
    public function assignData($data)
    {
        ...
        $key = 'qenta_checkoutpage_invoiceb2b_company_trade_reg_number';
        if (is_array($data)) {
    ...
    public function getCompanyTradeRegistrationNumber() {
        ...
        if($additionalInfo->hasAdditionalInformation('qenta_checkoutpage_invoiceb2b_company_trade_reg_number'))
        {
            $userCtrn = $additionalInfo->getAdditionalInformation('qentacheckout_page_invoiceb2b_company_trade_reg_number');
