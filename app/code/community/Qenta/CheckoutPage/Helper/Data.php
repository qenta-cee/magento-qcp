...
class Qenta_CheckoutPage_Helper_Data extends Mage_Payment_Helper_Data
{
    ...
    {
        $type =  Mage::getStoreConfig('qenta_checkoutpage/settings/configuration', $storeId);
    ...
    {
        return QentaCEE_QPay_FrontendClient::generatePluginVersion('Magento', Mage::getVersion(), $this->_pluginName, $this->_pluginVersion);
    }
    ...
    public function log($message, $level = null)
    {
        ...
        Mage::log($message, $level, 'qenta_checkoutpage.log', true);
    }
